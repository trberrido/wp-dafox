...
function df__register_blocks_types(): void {
	...
	wp_register_block_metadata_collection(
		get_stylesheet_directory() . '/assets/blocks/blocks',
		get_stylesheet_directory() . '/assets/blocks/blocks/blocks-manifest.php',
	);

	foreach ( glob( get_stylesheet_directory() . '/assets/blocks/blocks/*' ) as $block_directory ) {
